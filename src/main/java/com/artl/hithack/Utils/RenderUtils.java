...
public class RenderUtils {
    ...
    public static void FillLine(Entity entity, AxisAlignedBB box) {
        ...
        RenderGlobal.renderFilledBox(box, 0, 1, 1, 0.3F);
        RenderGlobal.drawSelectionBoundingBox(box, 0, 1, 1, 0.8F);
    ...
    public static void blockESP(BlockPos blockPos) {
        ...
        RenderGlobal.renderFilledBox(new AxisAlignedBB(x, y, z, x + 1.0, y + 1.0, z + 1.0), 0, 1, 1, 0.5F);
