...
public class Slider extends Component {
	...
	public void renderComponent() {
		...
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset + 8, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 12,hovered ? new Color(0x0090FF).hashCode() : new Color(0x38A0FF).hashCode());
		GL11.glPushMatrix();
